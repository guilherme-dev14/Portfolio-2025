  ...
  return (
    <SectionContainer id="about" title="About Me">
      <div className="flex items-center justify-between md:justify-center">
        ...
        >
          <p>
            Hi, My name is Guilherme Medeiros. I&apos;m 22 years old and
            I&apos;m a web development enthusiast. I usually use Vue.js,
            TypeScript and .NET Core in my projects, but I have experience with
            React and JavaScript as well.
          </p>

          <p>
            Currently studying software engineering and working as Full-Stack
            Developer.
          </p>
